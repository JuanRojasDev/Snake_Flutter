    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          textBasicStyle(
              "Nombre Científico", widget.infoSnake.nombreCientifico, Colors.black87),
          textBasicStyle(
              "Es Venenosa", widget.infoSnake.venenosa ? 'Sí' : 'No', Colors.black87),
          SizedBox(height: 16),
