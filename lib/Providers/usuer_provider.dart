...
class UserProvider extends ChangeNotifier {
  Usuario _usernow = Usuario(nombres: '', correo: '', fechaN: '',imagen_fondo: '',descripcion: '');
  Usuario _userdefault = Usuario(nombres: '', correo: '', fechaN: '',imagen_fondo: '',descripcion: ''); // Initialize with default values
